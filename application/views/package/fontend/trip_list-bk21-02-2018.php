...
<h2 class="title-detail" style="color: #2f79b1;">
	<?php echo $txt_routeType?>
</h2>
<!-- Accordion -->
	...
	<div class="panel">
		...
		<div class="panel-heading" id="heading<?php echo $times2->id?>">
			<h4 class="panel-title">
				<div class="col-md-9">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $times2->id?>" title="view detail">
					...
					<span class="icon fa fa-angle-up" style="color: red;font-weight: bold"></span>
					</div>
				</a>
				</div>
