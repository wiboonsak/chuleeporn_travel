...
$('.summernote').summernote({
    ...
    function Add() {
        ...
        var descth = $('#descth').summernote('code');
    var currentID = $('#currentID').val();
        if (name == '') {
            swal(
                    {
                        title: 'Please enter Package Name English!',
			    ...
			    swal(
					{
						title: ' Please enter Package Name Thai!',
						confirmButtonClass: 'btn btn-confirm mt-2',
						type: 'warning'
					}
				)
			    ...
			    swal(
					{
						title: ' Please enter Package Detail English!',
						confirmButtonClass: 'btn btn-confirm mt-2',
						type: 'warning'
					}
				)
			    ...
			    swal(
					{
						title: ' Please enter Package Detail Thai!',
						confirmButtonClass: 'btn btn-confirm mt-2',
						type: 'warning'
					}
				)
