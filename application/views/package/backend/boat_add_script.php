...
<script type="text/javascript">
    ...
    "search" : false
     ...
     function Add() {
        ...
        if (name == '') {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('PackageCMS/addboat') ?>',
                processData: false,
                contentType: false,
                data: postData,
                success: function (data, status) {
                    ...
                    if (status == 'success') {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo base_url('PackageCMS/Boatadd') ?>" ;
                        }, 2000);
                    } else {
                        swal({
    ...
    //----------------------------------
   function  loadSeason() {
        $.post('<?php echo base_url('PackageCMS/loadboat') ?>', {}, function (data) {
    ...
    function updateThis(dataID) {
        ...
        if (name == '') {
            ...
            swal({
                ...
                $.post('<?php echo base_url('PackageCMS/updateboat') ?>', {name: name, currentID: dataID}, function (data) {
                    if (data > 0) {
                        $('#name').val('');
                        swal({
