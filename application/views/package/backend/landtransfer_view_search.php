<form method="post" action="<?php echo base_url(); ?>PackageCMS/actionlandtran">
 ...
 <?php 
    ...
    foreach ($checkinData->result() AS $Data) {?>	
                                        <tr id="row<?php echo $Data->id ?>" class="removech" <?php if($Data->cf_status=='1'){ echo 'style="background-color: #DAFFD8"';}?>  >
                                            ...
                                            <td style="text-align:center;"><a href="<?php echo base_url('application/views/package/fontend/transportPDF/booking_pdf_'.$Data->Booking_id.'.pdf')?>" target="_blank"><i class="fa fa-file-pdf-o fa-2x" style="cursor:pointer;width: 15%"></i></a></td>
