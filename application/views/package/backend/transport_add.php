...
?>
              <form enctype="multipart/form-data" id="TransportForm" name="TransportForm">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Transprot English:</label>
                    <div class="col-sm-9">
                        <input type="text" id="name" name="name" class="form-control form-control-sm" value="<?php if ($currentID != '') {echo $Data->transport_name_en; } ?> " >
                    </div>
                </div>
                   <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Transprot Thai:</label>
                    <div class="col-sm-9">
                        <input type="text" id="nameth" name="nameth" class="form-control form-control-sm" value="<?php if ($currentID != '') {echo $Data->transport_name_th; } ?> " >
                    </div>
                </div>
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea id="descth" name="descth" type="text" class="ex"><?php if ($currentID != '') {echo $Data->transport_info_th; } ?></textarea>
                    </div>
                </div>
                  <div class="form-group row">
