   ...
   alert('Select atleast one records');
		...
		var datepicker2 = $('#datepicker2').val();				
		 if(datepicker2==''){
                ...
                $.post('<?php echo base_url('PackageCMS/searchdataTrancancel')?>' , { dateStart : datepicker1 , booking_status:booking_status,payment_type:payment_type , partner_id:SearchBooking , dateEnd:datepicker2 , dataID:dataID } , function(data){
