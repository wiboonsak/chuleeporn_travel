   ...
   alert('Select atleast one records');
		...
		var datepicker2 = $('#datepicker2').val();				
		 if(datepicker2==''){
                ...
                $.post('<?php echo base_url('PackageCMS/searchdataTransave')?>' , { dateStart : datepicker1 , payment_status:payment_status,payment_type:payment_type , partner_id:SearchBooking , dateEnd:datepicker2 , dataID:dataID } , function(data){
