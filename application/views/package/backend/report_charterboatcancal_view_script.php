  ...
  else
  {
   alert('Select atleast one records');
	    ...
	    var  SearchBooking='all';
			...
			$.post('<?php echo base_url('PackageCMS/Charterboat_Search')?>' , { booking_status:booking_status , dataID:dataID,datebook:datepicker1, SearchBooking:SearchBooking,cfstatusno1:cfstatusno1 ,cfstatusno2:cfstatusno2,cfstatus:cfstatus,SearchBookingpart:SearchBookingpart } , function(data){ 
