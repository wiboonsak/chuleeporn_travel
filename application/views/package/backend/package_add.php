...
?>
              <form enctype="multipart/form-data" id="packageForm" name="packageForm">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Package Name English: <a style="color:red;">*</a></label>
                    <div class="col-sm-9">
                        <input type="text" id="name" name="name" class="form-control form-control-sm" value="<?php if ($currentID != '') {echo $Data->package_name_en;}  ?> " >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Package Name Thai : <a style="color:red;">*</a></label>
                    <div class="col-sm-9">
                        <input type="text" id="nameth" name="nameth" class="form-control form-control-sm" value="<?php if ($currentID != '') {echo $Data->package_name_th;}  ?> " >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Package Detail English: <a style="color:red;">*</a></label>
                    <div class="col-sm-9">
                        <textarea id="desc" name="desc" type="text" class="summernote "><?php if ($currentID != '') {echo $Data->package_detail; } ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Package Detail Thai: <a style="color:red;">*</a></label>
                    <div class="col-sm-9">
                        <textarea id="descth" name="descth" type="text" class="summernote "><?php if ($currentID != '') {echo $Data->package_detail_th; } ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
		...
		$listpackage_feature=$this->Package_model->listpackage_feature($datatype);
                         ...
                         if(in_array($data->id, $arr)){  $bb = 'checked';  }else { $bb = ''; }                                                            
                                                                                    ?>
                        <div class="col-12 checkbox checkbox-success checkbox-circle">
