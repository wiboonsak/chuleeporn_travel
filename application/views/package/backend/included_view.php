...
?>
              <form enctype="multipart/form-data" id="includedForm" name="includedForm">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Included English:</label>
                    <div class="col-sm-9">
                        <input type="text" id="sname" name="name" class="form-control form-control-sm" value="<?php if ($currentID != '') {echo $Data->include_name_en; } ?> " >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Included Thai:</label>
                    <div class="col-sm-9">
                        <input type="text" id="snameth" name="nameth" class="form-control form-control-sm" value="<?php if ($currentID != '') {echo $Data->include_name_th; } ?> " >
                    </div>
                </div>
                   <div class="form-group row" >
