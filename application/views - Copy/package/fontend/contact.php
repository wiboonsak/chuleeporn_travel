                       ...
                       <div class="col-sm-3">
                        ...
                        <div class="about-text">
                            ...
                            <div class="about-description">                                
								...
								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #d8d8d8;">Email: booking@akiraspeedboat.com</p>   
								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #d8d8d8;">Mobile: +66 (0) 98 161 6164 </p>                          
								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #d8d8d8;">Line: </p>
								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #d8d8d8;">Address: 370 Moo 7 Koh Lipe, Koh Sarai Sub-district,
