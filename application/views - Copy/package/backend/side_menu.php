...
<title>AkiraSpeedBoat Control</title>
    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li> <p style="background-color: #d83f3f; font-size: 15px; line-height: 2.6; padding-left: 20px; margin-bottom: 0px; color: #FFFFFF;"> <strong>Transport Managing</strong> </p>
                    <!--</a>-->
                </li>
                <li>
                ...
                <li> <p style="background-color: #d83f3f; font-size: 15px; line-height: 2.6; padding-left: 20px; margin-bottom: 0px; color: #FFFFFF;"> <strong>Package Managing</strong> </p>
                    <!--</a>-->
                </li>
                <li>
                ...
                <li> <p style="background-color: #d83f3f; font-size: 15px; line-height: 2.6; padding-left: 20px; margin-bottom: 0px; color: #FFFFFF;"> <strong>Report</strong> </p>
                    <!--</a>-->
                </li>
                 <li>
                 ...
                 <li>
                   ...
                   <li> <p style="background-color: #d83f3f; font-size: 15px; line-height: 2.6; padding-left: 20px; margin-bottom: 0px; color: #FFFFFF;"> <strong>Admin Managing</strong> </p>
                    <!--</a>-->
                </li>
		  <li>
